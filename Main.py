...
class Grafo():
    ...
    def exibirStories(self, usuario):
        ...
        """
        print(f"\033[1;31mVisualizar story de: {usuario}\033[m")
            ...
            for adjacente in self.matrizAdj[primeiro_elemento].keys():
                if adjacente == usuario2:
                    ...
                    for no in caminho_invertido[::-1]:
                        caminho += f'{no} -> '
                    return print(f"\033[1;31mO caminho entre os dois usuários informados é :{caminho[:-3]}\033[m")
...
print("\033[1;32m                   INSTACODERS\033[m")
print("\033[1;35m*\033[m"*50)
print(f"\033[1;31mExibir topK: Os mais seguidos\033[m")
odisseia.topK(5)

print("\033[1;35m*\033[m"*50)
print("\033[1;31mQuantidade de seguidores:\033[m")
odisseia.exibeSeguidores("sophia31")

print("\033[1;35m*\033[m"*50)
print("\033[1;31mQuantidade de seguidos:\033[m")
odisseia.exibeSeguidos("sophia31")

print("\033[1;35m*\033[m"*50)
odisseia.exibirStories("sophia31")
print("\033[1;35m*\033[m"*90)
